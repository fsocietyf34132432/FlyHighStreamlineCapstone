...
namespace FlyHighStreamlineCapstone.Controllers
{
    public class PassengersController : Controller
    {
        ...
        public PassengersController(FlyHighStreamlineCapstoneContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PassengerId,FirstName,LastName,DateOfBirth,PassportNumber,Nationality")] Passenger passenger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PassengerId,FirstName,LastName,DateOfBirth,PassportNumber,Nationality")] Passenger passenger)
        {
